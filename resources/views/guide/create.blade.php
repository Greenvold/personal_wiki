                        ...
                        <div class="form-group row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control"
                                    rows="4">{{isset($guide) ? $guide->short_description : ''}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <textarea name="content" id="content" cols="30"
                                    rows="10">{{isset($guide) ? $guide->content : ''}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="text" placeholder="Select date" class="form-control" name="published_at"
                                    id="published_at" value="{{isset($guide) ? $guide->published_at : ''}}">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
